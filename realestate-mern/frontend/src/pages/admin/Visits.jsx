...
const Visits = () => {
  ...
  return (
    <div>
                        ...
                        {user?.role === "admin" &&
                          (visit.convertedLead ? (
                            ...
                            <button
                              ...
                              title={
                                visit.status === "pending_agent_review"
                                  ? "Approve this visit and create the pipeline lead in one step"
                                  : "Create a pipeline lead from this visit"
                              }
                            >
                              {visit.status === "pending_agent_review"
      ...
      {/* Convert to Lead Modal (admin) - the unified accept handler:
          approving a pending visit and converting it are one action */}
      {convertTarget && (
        <ConvertToLeadModal
          sourceType="visit"
